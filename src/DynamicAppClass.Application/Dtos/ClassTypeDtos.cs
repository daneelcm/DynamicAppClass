...
public sealed record ClassTypeDetailDto(int Id, string Name, string Description, IReadOnlyList<ClassFieldDto> Fields, IReadOnlyList<ClassActionDto> Actions, Guid ConcurrencyToken);
public sealed record ClassFieldDto(int Id, string Name, ClassFieldType FieldType, bool IsRequired, bool IsHidden, string? DefaultValue, int SortOrder, IReadOnlyList<FieldOptionsDto> Options);
...
public sealed record AddFieldRequest(string Name, ClassFieldType FieldType, bool IsRequired, bool IsHidden, string DefaultValue, int SortOrder, IReadOnlyList<string>? Options, Guid ConcurrencyToken);
