...
public sealed record CreateClassInstanceRequest(int ClassTypeId, string? Title, IReadOnlyDictionary<int, string?> FieldValues, IReadOnlyDictionary<string, object[]> FeaturesData);
